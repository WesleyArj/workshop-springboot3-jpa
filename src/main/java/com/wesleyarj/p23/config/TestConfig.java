...
import com.wesleyarj.p23.entities.Payment;
...
import com.wesleyarj.p23.repositories.OrderItenRepository;
import com.wesleyarj.p23.repositories.OrderRepository;
import com.wesleyarj.p23.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	@Autowired
	private ProductRepository PrRp;
	
	@Autowired
	private OrderItenRepository oir;
	...
	public void run(String... args) throws Exception {
		...
		PrRp.saveAll(Arrays.asList(p1, p2, p3, p4, p5));
